...
<header>
        <div class="container">
                <a class="logo" href="<?php bloginfo('HOME');?><?php the_custom_logo();?>"><img src=" <?php bloginfo('template_directory');?>/images/logo-white.png" alt="Logo"></a>
                ...
                wp_nav_menu(
                        array (
                                ...
                                'menu-id' => 'main-menu',
                                'container'=> 'ul',
                                'menu-class' => 'main-menu font-mountainsre',
                                )
                );
                ?>
